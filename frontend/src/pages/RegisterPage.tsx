        ...
        <div className="flex items-center justify-center p-4 md:p-8">
          ...
          >
            ...
            <div className="text-center text-sm text-muted-foreground">
              <p>Already have an account? <Link to="/login" className="font-semibold text-foodly-primary hover:underline">Sign in</Link></p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="flex h-full items-center justify-center bg-black/40 p-8">
            <div className="max-w-md text-center text-white">
              ...
              <motion.p
                ...
                className="mb-6"
              >
                Create an account to order food from top restaurants or list your restaurant on our platform
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
